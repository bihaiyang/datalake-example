...
import org.bii.example.iceberg.flink.sql.WriteSQL;
 ...
 * @since 2023/05/23
 */
public class FlinkSqlIcebergWrite {
    
    public static void main(String[] args) {
        
        StreamTableEnvironment env = FlinkSqlConf.getBatchEnv();
        List<String> sqlList = new ArrayList();
        CreateCatalogSQL.init(sqlList);
        sqlList.add(WriteSQL.INSERT_OVER_SQL);
